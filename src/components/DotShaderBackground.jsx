...
function Scene() {
    ...
    // Hardcoded light theme colors from user reference - Tweaked for visibility
    const themeColors = {
        dotColor: '#808080', // Darker gray for better visibility
        bgColor: '#F4F5F5',
        dotOpacity: 0.4 // Increased opacity
    }
