...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Ensure logo is loaded from public/images */}
        <img src="/images/LOGO_forwebsite.svg" alt="Clouds Logo" className="w-80 md:w-96 h-auto opacity-90 hover:opacity-100 transition-opacity duration-300" />
